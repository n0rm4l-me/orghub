      ...
      <Dialog.Portal>
        ...
        >
          ...
          <Dialog.Description className="mt-1 text-sm text-gray-500">
            You have <span className="font-semibold text-gray-900">{available}</span> coins available.
          </Dialog.Description>

          <div className="mt-5 space-y-3">
            {types.length >= 2 && (
              <div>
                <p className="mb-2 text-xs font-medium text-gray-700">Redeem for</p>
            ...
            {types.length === 1 && (
              <p className="text-xs text-gray-500">
                Redeem for: <span className="font-medium text-gray-700">{types[0].label}</span>
              </p>
            )}
